...
def main():
    ...
    arms = [
        ...
        ("mean_dynamics_local", comparison / "mean_dynamics_local", True, True),
        ("mean_dynamics_cross_gap", comparison / "mean_dynamics_cross_gap", bool(mean_results["mean_dynamics_cross_gap"]), False),
    ]
    summary = []
    comparison_args = []
