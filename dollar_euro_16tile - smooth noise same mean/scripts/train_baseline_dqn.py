...
def main():
    ...
    contractivity_env = ContinuousDollarEuroEnv(
        render_mode=None, auto_render=False, **environment
    )
    contractivity_env.validate_wasserstein_contractivity(args.gamma)
    contractivity_env.close()
