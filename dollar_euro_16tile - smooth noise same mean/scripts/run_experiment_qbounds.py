...
def validate_cross_category_artifact(
    ...
    if kind == "cross_tile":
        ...
        check(
            data.get("Lr_estimator") == "local_max",
            "missing or incompatible Lr_estimator (required 'local_max')",
        )
        ...
        check(
            data.get("Lf_estimator") == "local_max",
            "missing or incompatible Lf_estimator (required 'local_max')",
        )
    check(
...
def main():
    ...
    print(
        "Dynamics Lf estimator:      "
        "data-fitted Wasserstein local_max"
    )
